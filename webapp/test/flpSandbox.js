		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#navigationandroutingnavigationandroutingproject1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"navigationandroutingnavigationandroutingproject1-display": {
								"semanticObject": "navigationandroutingnavigationandroutingproject1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=navigationandrouting.navigationandroutingproject1",
									"url": sap.ui.require.toUrl("navigationandrouting/navigationandroutingproject1")
								}
							}
						}
					}
